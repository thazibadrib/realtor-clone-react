        ...
        <div className="flex space-x-6 justify-start mb-6">
          <div>
            ...
            <input
              ...
              max="50"
              required
              className=" w-full px-4 py-2 text-xl text-gray-300 bg-white border border-gray-700 rounded transition duration-150 ease-in-out focus:text-gray-800 focus:bg-white focus:border-slate-600 text-center"
            />
          </div>
          <div>
          ...
          <div className="">
            ...
            <div className="flex w-full justify-center items-center space-x-6 ">
              <input
                ...
                max="400000000"
                required
                className="w-full px-4 py-3 text-xl text-gray-700 bg-white border border-gray-300 rounded transition duration-150 ease-in-out focus:text-gray-700 focus:bg-white focus:border-slate-600 text-center "
              />
